...
public static class GalaxyKnobRegistry
{
    ...
    private static readonly GalaxyKnobDef[] Table =
    {
        ...
        // ---- Evolution (life, sapience, the emergence schedule, waves) ----
        ...
        K("Evolution.BioEngineeringRate",
          "peak-phase biosphere-engineering chance per owned living cell per step",
          c => c.Evolution.BioEngineeringRate,
          (c, v) => c.Evolution.BioEngineeringRate = v),
        ...
        K("Evolution.DomainBudgetFraction",
          "share of cells claimable by precursor waves across deep time",
          c => c.Evolution.DomainBudgetFraction,
          (c, v) => c.Evolution.DomainBudgetFraction = v),
        K("Evolution.DormantSurvivalRate",
          "share of end-state precursor sites that stay live (dormant)",
          c => c.Evolution.DormantSurvivalRate,
          (c, v) => c.Evolution.DormantSurvivalRate = v),
        K("Evolution.GrandChance",
          "chance a precursor wave draws the grand vigor class",
          c => c.Evolution.GrandChance,
          (c, v) => c.Evolution.GrandChance = v),
        K("Evolution.GrandWaveLimit",
          "most grand waves per galaxy (the elder races are few)",
          c => c.Evolution.GrandWaveLimit,
          (c, v) => c.Evolution.GrandWaveLimit = v),
