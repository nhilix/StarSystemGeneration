...
| 2 | **Markets** | Production (cells + infrastructure) → demand (population use-cases, industry, military, tech) → **price formation per market** → trade flows route under freight capacity (tariffs, blockades, sanctions constrain) → revenues, tax take |
...
| 5 | **Resolution** | Acts collide and resolve deterministically: expansion claims, fleet movement and positioning, war fronts and battles, blockades established, diplomacy matched (consent required both sides), annexations, capital falls |
