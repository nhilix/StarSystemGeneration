...
| unserved profitable lanes | freight line — posts hulls, and **builds gate pairs across profitable non-hostile borders** (no treaty required), owning and tolling both gates |
